...
- **🏋️ Szybki ruch** — trzeci pływający przycisk: start/stop treningu na żywo albo dodanie zakończonej aktywności jednym kliknięciem (kategoria + 15–120 min, zapis wstecz od „teraz").
- **😴 Szybki sen** — czwarty pływający przycisk: „Zasypiam / Pobudka" jednym dotknięciem albo szybki zapis ostatniej nocy (zaśnięcie → pobudka, data liczona automatycznie).
...
- **🧾 Konfigurowalne składniki odżywcze** — w profilu wybierasz, co śledzisz (białko, woda, kalorie, węglowodany, tłuszcz, cukry, błonnik, sól — każde można włączyć/wyłączyć); domyślne dzienne normy dla zdrowej osoby dorosłej z możliwością edycji; zaznaczone składniki pojawiają się w tabelach dziennika, podsumowaniu, bazie produktów, na wydruku, w wykresie spożycia i w CSV.
